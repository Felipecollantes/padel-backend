...
export const leagueApiResponses = [leagueCreatedResponse, leagueBadRequestResponse, leagueNotFoundResponse];

export const leaguesApiResponses = [leaguesResponse, leagueBadRequestResponse, leagueNotFoundResponse];

export const leagueDeleteApiResponses = [leagueDeleteResponse, leagueBadRequestResponse, leagueNotFoundResponse];
