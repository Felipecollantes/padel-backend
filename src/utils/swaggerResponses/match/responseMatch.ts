...
export const createMatchApiResponses = [matchCreatedResponse, matchBadRequestResponse, matchNotFoundResponse];

export const matchApiResponse = [matchResponse, matchBadRequestResponse, matchNotFoundResponse];

export const matchesApiResponse = [matchesResponse, matchBadRequestResponse, matchNotFoundResponse];

export const matchDeleteApiResponse = [matchDeleteResponse, matchBadRequestResponse, matchNotFoundResponse];
