...
export class LeagueController {
  ...
  @Get('league/:param')
  @ApiOperation({
    summary: 'Get league by param (name or ID)',
    description: 'Retrieve a league by a specific parameter (name or ID)',
  })
  @ApiResponses(leagueApiResponses)
  @ApiParam({
    name: 'param',
    description: 'Parameter to search the league by name or id',
    type: 'string',
  })
  ...
  @ApiOperation({
    ...
    description: 'Search and list leagues by name',
  })
  @ApiResponses(leaguesApiResponses)
  @ApiParam({
    name: 'name',
    description: 'Name of the league to search',
    type: 'string',
  })
  ...
  @ApiOperation({
    ...
    description: 'Update details of a specific league',
  })
  @ApiResponses(leagueApiResponses)
  @ApiParam({
    name: 'id',
  ...
  update(@Param('id', ParseUUIDPipe) id: string, @Body() updateLeagueDto: UpdateLeagueDto): Promise<LeagueResponseDto> {
  ...
  @ApiOperation({
    ...
    description: 'Deactivate a specific league from the system',
  })
