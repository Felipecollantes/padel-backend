...
export class UsersController {
  ...
  @Auth()
  @Post('friendship')
  @ApiOperation({ summary: 'Create friendship', description: 'Establish a new friendship between users' })
  ...
  @Auth()
  @Get()
  @ApiOperation({ summary: 'List users', description: 'Get a paginated list of users' })
  ...
  @Auth()
  @Get('user/:param')
  @ApiOperation({ summary: 'Get user by param (name or ID)', description: 'Retrieve a user by a specific parameter (name or ID)' })
  ...
  @Auth()
  @Get(':param')
  @ApiOperation({ summary: 'Search users', description: 'Search users by a specific parameter' })
  @ApiParam({name: 'param', description: 'Specific user parameter to search'})
  ...
  @Auth()
  @Delete(':id')
  @ApiOperation({ summary: 'Deactivate user', description: 'Deactivate a specific user from the system' })
